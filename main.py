...
def main():
    ...
    parser.add_argument('--AIS_state_size', type=int, default=8)
    ...
    parser.add_argument('--random_actions_until',type=int, default=100)
    parser.add_argument('--start_updates_to_model_after', type=int, default=0)
    parser.add_argument('--start_updates_to_p_q_after', type=int, default=1000)
    ...
    parser.add_argument('--rl_alg', type=str, default='SAC')
    parser.add_argument('--model_alg', type=str, default='AIS')
